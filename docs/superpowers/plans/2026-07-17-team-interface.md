...
- [ ] 3. Verzeichnis `/opt/coldmailing/` anlegen: Code (git clone/rsync), `.env` (Schlüssel von Hand auf dem Server eintragen, nie kopieren über unsichere Wege), Volume-Ordner `daten/` (kunden/, laeufe/, sperrliste-global.yaml, users.yaml).
